...
from faster_whisper_api.preload.faster_whisper_model import FasterWhisperAPIModelFactory
...
class FasterWhisperModelServiceContainer(containers.DeclarativeContainer):
    ...
    model = providers.ThreadSafeSingleton(FasterWhisperAPIModelFactory)
